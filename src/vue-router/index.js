...
import WelcomePage from '../vue/auth/WelcomePage'
...
import ArtCreation from '../vue/app/artCreation/ArtCreation.Entry'
import ArtCreationIndex from '../vue/app/artCreation/index/ArtCreation.Index'
...
import Arts from '../vue/app/arts/Arts.Entry'
import ArtsDetails from '../vue/app/arts/art_details/Arts.Details'
import ArtsExplore from '../vue/app/arts/overview/Arts.Explore'
  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        {
          feature_flag: config.FEATURE_FLAGS.artCreation,
          name: 'app.artCreation',
          path: '/art-creation',
          component: ArtCreation,
          redirect: { path: '/art-creation/index' },
          children: [
            {
              path: '/art-creation/index',
              name: 'art-creation.index',
              meta: { pageName: PAGES_NAMES.createArt },
              component: ArtCreationIndex,
              props: true
            },
            {
              path: '/art-creation/index/:id',
              name: 'art-creation.index:id',
              meta: { pageName: PAGES_NAMES.createArt },
              component: ArtCreationIndex,
              props: true
            }
        ...
        {
          feature_flag: config.FEATURE_FLAGS.arts,
          name: 'app.arts',
          path: '/arts',
          component: Arts,
          redirect: { path: '/arts/explore' },
          children: [
            {
              path: '/arts/explore',
              name: 'arts.explore',
              meta: { pageName: PAGES_NAMES.exploreArts },
              component: ArtsExplore
            },
            {
              path: '/arts/details/:id',
              name: 'arts.art-details',
              meta: { pageName: PAGES_NAMES.exploreArts },
              component: ArtsDetails,
              props: true
            }
          ]
        },
