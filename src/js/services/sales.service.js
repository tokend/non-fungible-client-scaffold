...
export class SalesService extends Service {
  ...
  /**
   * Creates sale creation request additionally updating token creation request. In ART, we need this to change tokens max issuance
  ...
  /**
   * Loads sale by token code. By default loads an array of sales, but because ART sale/tokens are 1-1 we can derive
   * 1st element here
   *
