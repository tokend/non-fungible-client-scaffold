...
export default {
  ...
  lbl_manager_arts: PAGES_NAMES.managerArts,
  lbl_deposit: 'Deposit',
  ...
  lbl_type_corporate: 'Artist account',
  lbl_tokens: 'Tokens',
  ...
  lbl_create_art_page: PAGES_NAMES.createArt,
  ...
  lbl_token_not_available_exp: 'Token creation is available only for artist users, complete verification to become one.',
  lbl_token_not_available_yet: 'Please create token before creating fund',
  lbl_issuance_not_available_exp: 'Issuance creation is available only for artist users, complete verification to become one.',
  ...
  lbl_art_code: 'Art code',
  lbl_art_name: 'Art name',
  lbl_art_description: 'Art description',
  lbl_art_creation: 'Art creation',
  lbl_art_bought: 'Bought for',
  lbl_art_sold: 'Sold for',
  lbl_art_fee: 'Fee',
  lbl_art_balance: 'Balance'
}
