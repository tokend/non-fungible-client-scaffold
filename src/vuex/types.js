const mutations = {
  ...
  // arts:
  SET_ALL_ARTS: 'SET_ALL_ARTS',
  SET_USER_OWNED_ARTS: 'SET_USER_OWNED_ARTS',
  SET_USER_ACQUIRED_ARTS: 'SET_USER_ACQUIRED_ARTS'
}
...
const getters = {
  ...
  // arts:
  arts: 'arts',
  walletArts: 'walletArts',
  userOwnedArts: 'userOwnedArts',
  userAcquiredArts: 'userAcquiredArts',
  userWalletArts: 'userWalletArts',
  userTransferableArts: 'userTransferableArts',
  userWithdrawableArts: 'userWithdrawableArts'
}
