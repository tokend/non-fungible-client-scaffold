            ...
            <md-table-cell colspan="7">
              <md-card-content class="md-layout md-gutter">
                <div class="icon-column md-layout-item md-size-35 md-layout md-alignment-center-center">
                  <router-link :to="{name: 'arts.art-details', params: { id: item.reference }}">
                  <img class="token-icon" v-if="item.photoUrl" :src='item.photoUrl' :alt="documentTypes.tokenIcon">
              ...
              <md-card-actions>
                ...
                <router-link :to="{name: 'art-creation.index', params: { id: item.id }}"
                             tag="button"
                             v-ripple
                             class="app__button-flat"
