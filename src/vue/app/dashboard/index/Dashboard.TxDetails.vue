<template>
  <withdrawal    v-if="tx instanceof Withdrawal" :tx="tx"/>
  <issuance      v-else-if="tx instanceof Issuance" :tx="tx"/>
...
<script>
  import Withdrawal from './components/Details.Withdraw'
  import Issuance from './components/Details.Issuance'
